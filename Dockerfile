...
FROM --platform=${PLATFORM} mcr.microsoft.com/playwright:v1.49.1-jammy
...
LABEL org.opencontainers.image.version="1.49.1"
...
LABEL org.opencontainers.image.base.name="mcr.microsoft.com/playwright:v1.49.1-jammy"
